...
namespace P230_Pronia.Migrations
{
    ...
    [Migration("20230410120441_AddIsOrderedColumn")]
    partial class AddIsOrderedColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P230_Pronia.Entities.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("P230_Pronia.Entities.BasketItem", b =>
                {
                    ...
                    b.Property<int>("PlantSizeColorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("P230_Pronia.Entities.Basket", b =>
                {
                    b.HasOne("P230_Pronia.Entities.User", "User")
                        .WithMany("Baskets")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("P230_Pronia.Entities.BasketItem", b =>
                {
                    b.HasOne("P230_Pronia.Entities.Basket", null)
                        .WithMany("BasketItems")
                        .HasForeignKey("BasketId");

                    b.HasOne("P230_Pronia.Entities.PlantSizeColor", "PlantSizeColor")
                        .WithMany("BasketItems")
                        .HasForeignKey("PlantSizeColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PlantSizeColor");
                });

            modelBuilder.Entity("P230_Pronia.Entities.Order", b =>
                {
                    b.HasOne("P230_Pronia.Entities.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("P230_Pronia.Entities.Order", "BasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
